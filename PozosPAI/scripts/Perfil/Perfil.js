...
class Perfil {
    ...
    create() {
        ...
        let backgroundPerfil = CreateElement({
            ...
            attributes: {
                ...
                style: `background: url(${Core.Instance.ResourcesPath}Perfil/background.jpg?v=${Core.Instance.version}); width: ${widthRenderPerfil}px; height: ${heightRender}px; background-size: cover; position: absolute;`
            }
        });
    ...
    #drag = (e) => {
        if (e.which == 1 && (e.currentTarget.doPanX || e.currentTarget.doPanY)) {
            ...
            this.verticalScroll.value = e.currentTarget.doPanY ? this.moveY : 0;
        }
    }
