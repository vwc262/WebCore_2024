...
export var ControladorCSV = {
    // se inicializa la funcion ObtenerCSV que recibe varios paramtros
    ObtenerCSV: function (chartReference, NombreEstacion, FechaInicial, FechaFinal, IdSegnalesSeleccionadas) {
        ...
        let aCSV = document.createElement("a");
