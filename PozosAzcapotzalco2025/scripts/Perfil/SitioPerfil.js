    ...
    createEtiqueta() {
        ...
        let nombreSitio = CreateElement({
            ...
            attributes: {
                ...
                style: `background: ${estacion.IsEnMantenimiento() ? 'rgb(129, 129, 129)' : estacion.IsTimeout() ? 'rgb(129, 11, 11)' : estacion.Enlace == EnumEnlace.FueraLinea ? "rgb(235, 13, 13)" : "rgb(0, 128, 0)"}`
            },
